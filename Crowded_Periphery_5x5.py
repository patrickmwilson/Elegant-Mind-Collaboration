...
#
# Displays a 5x5 block of characters in the peripheral region. The 
# subject is tasked with identifying the character in the center of the block.
# To see a photo of this experiment, open the 'cp5.png' file within the 
...
# Generates and displays a 5x5 block of characters randomly selected 
...
def genArray(size, heightCm, xPos, yPos):
    ...
    for i in range(rows):
        ...
        for j in range(cols):
            ...
            # Row 2, Col 2 is the center. Return this character, as the subject
