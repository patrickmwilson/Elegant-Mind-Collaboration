...
plotAllData = strcmp(char(dataAnswer(2)),'l');
if strcmp(char(dataAnswer(1)),'C')
    return;
end

if plotAllData
    sub_info = {'Averaged','Averaged'};
else
