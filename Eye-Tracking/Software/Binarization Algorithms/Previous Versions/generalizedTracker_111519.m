function [allObjectStats, objectsLost, storedCentroids] = genEyeTracking();
    clear all;
    close all;
    ...
    folderName = 'Trevor_Calibration_110519_All';
    mkdir(folderName);
    cd(folderName);
...
%                     end                
        ...
        save(strcat(folderName, '.mat'), 'allObjectStats', 'objectsLost', 'storedCentroids', 'rotateVectAll');    
