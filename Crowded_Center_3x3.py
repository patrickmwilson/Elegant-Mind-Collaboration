...
# identify, as well as a 3x3 block of characters in the center of the screen.
#  To see a photo of this experiment, open the 'cc3.png' file within 
...
# Generates and displays a 3x3 block of characters randomly selected
# from 'E', 'B', and 'P' at the center of the screen. 
#
# PPE
# EEB
# PBP
...
for pair in pairs: # Loop through the list of pairs
    ...
    while not stairCaseCompleted:
        ...
        # Generate and draw the 3x3 block of characters at the center
        ...
        while 1:
            ...
            # display of the stimulus characters and the center block
