...
#
# Displays a 7x7 block of characters in the peripheral region. The 
# subject is tasked with identifying the character in the center of the block.
# To see a photo of this experiment, open the 'cp7.png' file within the 
...
# Generates and displays a 7x7 block of characters randomly selected 
